...
import cn.com.example.smartlife.im.config.Extras;
import cn.com.example.smartlife.im.config.SysInfoUtil;
...
public class WelcomeActivity extends UI {
    ...
    private void showSplashView() {
        getWindow().setBackgroundDrawableResource(R.mipmap.welcome);
        customSplash = true;
    }
